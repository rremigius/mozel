...
export declare type ModelConstructor<T extends Model> = {
    new (...args: any[]): T;
    type: string;
};
...
export declare type PropertyKeys<T extends Model> = {
    [K in keyof T]: T[K] extends PropertyValue ? K : never;
}[keyof T];
export declare type CollectionData<T> = T extends Model ? ModelData<T>[] : T extends primitive ? T[] | Collection<T> : never;
export declare type PropertyData<T> = T extends PropertyValue ? T extends Model ? ModelData<T> : T extends Collection<infer C> ? CollectionData<C> : T : false;
export declare type ModelData<T extends Model> = T extends {
    ModelDataType: any;
} ? T['ModelDataType'] : {
 ...
 */
export declare function property(runtimeType?: PropertyType, options?: PropertyOptions): (target: Model, propertyName: string) => void;
/**
 * PROPERTY decorator factory
 ...
 */
export declare function collection(runtimeType?: CollectionType, options?: CollectionOptions): (target: Model, propertyName: string) => void;
...
export default class Model {
    ...
    constructor(modelFactory?: ModelFactoryInterface, registry?: Registry<Model>);
     ...
     */
    create(Class: ModelClass, data?: Data, root?: boolean, asReference?: boolean): Model;
    destroy(): void;
    /**
     ...
     */
    setParent(parent: Model, relation: string, lock?: boolean): void;
    /**
     * Get the Model's parent.
     */
    getParent(): Model | null;
    /**
     ...
     * @return {Collection}
     */
    defineCollection(relation: string, type?: CollectionType, options?: CollectionOptions): Collection<primitive | Model>;
    /**
