 ...
 */
export function property(runtimeType, propertyOptions) {
 ...
 */
let Mozel = class Mozel {
    static { Mozel_1 = this; }
    _type; // just for MozelData typing
    ...
    static _classPropertyDefinitions = {};
    // Injected properties
    $factory;
    $registry;
    _config = {};
    ...
    _strict;
    _watchers;
    _trackChangesID = undefined;
    _trackedChangePaths = new Set();
    $root = false;
    $destroyed = false;
    $events;
    gid; // a non-database ID that can be used to reference other mozels
    /**
    ...
    static defineClassProperty(name, runtimeType, options) {
        this.classPropertyDefinitions[name] = { name, type: runtimeType, options: options };
    }
    /**
    ...
    static create(data, config) {
        ...
        return factory.createRoot(this, data, config);
    }
    ...
    $setProperty(property, lock = false) {
     ...
     */
    $notifyPropertyBeforeChange(path) {
        if (this._trackChangesID) {
    ...
    $cloneDeep() {
        ...
        return factory.create(this.$static, this.$export(), this._config);
    }
    /**
